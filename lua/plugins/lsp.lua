...
return {
  ...
  ---------------------------------------------------------------------
  {
    ...
    config = function()
      ...
      -- d) Diagnostic signs/icons & inline messages
      ...
      vim.diagnostic.config({
        -- show virtual text next to the offending line
        virtual_text = {
          prefix = '', -- a little icon
          spacing = 4, -- how much space between code and text
          severity = { min = vim.diagnostic.severity.ERROR }, -- only for errors
        },
        signs = true, -- keep the gutter signs
        underline = true, -- keep squiggles
